package kr.hhplus.be.server.api.controller.order;
...
public class OrderControllerTest {
    ...
    void get_cart_total_price_success() throws Exception {
        ...
        orderItemJpaRepository.save(OrderItem.of(userId, productA.getId(), optionA.getId(), 1000L, 2));
        orderItemJpaRepository.save(OrderItem.of(userId, productB.getId(), optionB.getId(), 1500L, 1));
