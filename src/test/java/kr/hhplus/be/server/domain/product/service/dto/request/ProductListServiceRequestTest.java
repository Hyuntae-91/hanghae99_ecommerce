...
class ProductListServiceRequestTest {
    ...
    void validInput_doesNotThrow() {
        assertThatCode(() -> new ProductListServiceRequest(1L, 10, "createdAt"))
    ...
    void pageLessThanOne_throwsException() {
        assertThatThrownBy(() -> new ProductListServiceRequest(0L, 10, "createdAt"))
    ...
    void sizeLessThanOne_throwsException() {
        assertThatThrownBy(() -> new ProductListServiceRequest(1L, 0, "createdAt"))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void sortIsNull_throwsException() {
        assertThatThrownBy(() -> new ProductListServiceRequest(1L, 10, null))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void sortIsBlank_throwsException() {
        assertThatThrownBy(() -> new ProductListServiceRequest(1L, 10, "  "))
                .isInstanceOf(IllegalArgumentException.class);
    }
