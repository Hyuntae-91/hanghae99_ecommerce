...
class CouponIssueTest {
    ...
    void calculateFinalPrice_fixed() {
        ...
        CouponIssue issue = new CouponIssue(1L, 1L, coupon.getId(), 0, "2024-01-01T00:00:00", "2099-01-01T00:00:00", "2024-01-01T00:00:00", "2024-01-01T00:00:00");
    ...
    void validateUsable_invalid_state() {
        Coupon coupon = new Coupon(1L, CouponType.FIXED, "desc", 1000, 10, 0, 7, "2024-04-11T00:00:00", "2024-04-11T00:00:00");
        CouponIssue issue = new CouponIssue(1L, 1L, coupon.getId(), 1, "2024-01-01T00:00:00", "2099-01-01T00:00:00", "2024-01-01T00:00:00", "2024-01-01T00:00:00");
